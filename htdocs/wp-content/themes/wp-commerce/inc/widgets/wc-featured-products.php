...
class WP_Commerce_Featured_Products extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            'classname'                     => 'wp_commerce_featured_products',
            'description'                   => __( 'Display numbers of featured products from selective categories.', 'wp-commerce' ),
            'customize_selective_refresh'   => true,
        );
        parent::__construct( 'wp_commerce_featured_products', __( 'WP Commerce: Featured Products', 'wp-commerce' ), $widget_ops );
    }
