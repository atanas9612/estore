...
class WP_Commerce_Hot_Products extends WP_Widget {
/**
     * Register widget with WordPress.
     */
public function __construct() {
    $widget_ops = array( 
        'classname'                     => 'wp_commerce_hot_products',
        'description'                   => __( 'Display numbers of Hot products.', 'wp-commerce' ),
        'customize_selective_refresh'   => true,
    );
    parent::__construct( 'wp_commerce_hot_products', __( 'WP Commerce: Hot Products', 'wp-commerce' ), $widget_ops );
}
