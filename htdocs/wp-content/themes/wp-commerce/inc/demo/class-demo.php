 ...
 * Demo class
 *
 * @package WP_Commerce_Pro
 */

if ( ! class_exists( 'WP_Commerce_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class WP_Commerce_Demo {

		/**
		 * Singleton instance of WP_Commerce_Demo.
		 *
		 * @var WP_Commerce_Demo $instance WP_Commerce_Demo instance.
		 */
		...
		/**
		 * Main WP_Commerce_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof WP_Commerce_Demo ) ) {
				self::$instance = new WP_Commerce_Demo();
